...
test('testing topbar menu', async ({ page }) => {
    ...
    await topBarMenu.organization.clickOnLocationOption()
    await topBarMenu.organization.clickOnOrganization()


    await topBarMenu.qualification.clickOnSkillsOption()
    await topBarMenu.qualification.clickOnEducationOption()
